...
# Pastikan file prometheus_exporter.py ada di folder yang sama
...
# Load Model
try:
    # Path ini mengacu ke folder /app/model di dalam container
...
def predict():
    ...
    try:
        ...
        # --- PERBAIKAN PENTING: DEFINISI KOLOM ---
        # Wajib ada karena model Anda dilatih dengan nama kolom spesifik
        column_names = [
        ...
        print(f"Error saat prediksi: {e}") # Print error ke log agar mudah debug
        APP_EXCEPTION.inc()
